...
This is a simple example of how much design patterns and oops concept , that I as a programmer know


# Contents

- `singhaidotnish` contains a project directory for a Python package.
- `singhaidotnish/src/demo_design_pattern` is the actual "package".
